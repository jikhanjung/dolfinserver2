...
| 검토 | **3,005 / 3,005** · 판정 **6,014건** · 안 본 것 0 |
| **새 검출** | **690 전부 검토** — 등지느러미 **419** · 딴 부위 152 · 헛것 119 |
| 사람이 그린 것 | 윗윤곽 **271** · 밑동 1,703 |
| **개체 분류** | 격자 **4,059**(`reid/v2`) · 상자에 **530** · 개체 **42** · 날을 건너뛴 개체 32 · 개체판정 **1,298** |
...
얼마나 잘 찾느냐이고, 그것이 곧 사람이 하나하나 안 붙여도 되게 하는 길이다.
    ...
    **top-1 29.7% · top-5 64.5%**   ← 넘어야 할 값
      (개체 42마리 중 고르기 · 질의 437 · 같은 날은 후보에서 뺀다)

이것을 움직이는 것 셋은 이미 재어 두었다.

    개체당 조각 수     4~9장 11.1% → 20장 이상 33.8%
    묶어서 묻기        낱장 22.7% → 5장 묶음 40.0% (top-5 **80%**)
    닫힌 판 학습       28.0% → 43.0%  (얼린 특징 위 선형 사영 하나로)
